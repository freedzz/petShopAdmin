  ...
  <div class="content-page">
    ...
    <div class="content-main">
      <div class="form-table-box">
        <el-form ref="infoForm" :rules="infoRules" :model="infoForm" labelWidth="120px">
          <el-form-item label="名称" prop="content"><el-input v-model="infoForm.content" placeholder="请输入名称" autofocus></el-input></el-form-item>
              ...
              <el-table :data="tableData" style="width: 100%" border stripe>
                ...
                <el-table-column label="操作" width="160">
                  <template slot-scope="scope">
                    <el-button size="small" type="primary" plain @click="handleRowEdit(scope.$index, scope.row)">编辑地区</el-button>
                  </template>
                </el-table-column>
              </el-table>
            </div>
    ...
    <el-dialog size="tiny" title="设置偏远地区" :visible.sync="specEditVisible">
      <el-form ref="specForm" class="specFormDialig">
        <el-form-item label="" labelWidth="100px">
