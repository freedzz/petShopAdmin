  ...
  <div class="wrap">
      ...
      <el-form :model="dform">
        <div class="dialog-wrap">
          <div class="d-list-wrap">
            <div v-for="(ditem, index) in orderInfo.goodsList" :key="index" class="d-goods-list">
        ...
        <el-form-item v-if="isShow" class="d-hoho" label="选择快递">
        ...
        <el-form-item v-if="isShow" class="d-haha" label="快递单号"><el-input v-model="dform.logistic_code"></el-input></el-form-item>
      </el-form>
    ...
    <el-dialog title="修改价格" :visible.sync="dialogPriceVisible" width="90%">
      <el-form :model="orderInfo">
        ...
        <el-form-item label="货款总价:"><el-input v-model="orderInfo.goods_price" autoComplete="off" placeholder="请输入修改后的价格"></el-input></el-form-item>
        <el-form-item label="快递费用:"><el-input v-model="orderInfo.freight_price" autoComplete="off" placeholder="请输入修改后的快递价格"></el-input></el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
