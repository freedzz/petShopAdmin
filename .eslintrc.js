module.exports = {
  ...
  'rules': {
    ...
    'no-async-promise-executor': 0, // promise中是否能使用async关键字
    ...
    // vue template风格配置 https://eslint.vuejs.org/rules/no-undef-properties.html
    'vue/html-closing-bracket-newline': [2, { // html 闭括号-换行
      'singleline': 'never',
      'multiline': 'always'
    }],
    'vue/html-end-tags': 2, // html 需要有结束标签，除了自闭合标签
    'vue/html-indent': [2, 2, ], // 缩进
    'vue/multiline-html-element-content-newline': [2, { // 内容元素为多行，对称换行
      'ignoreWhenEmpty': true,
      'allowEmptyLines': true
    }],
    'vue/html-closing-bracket-spacing': [2, { // html 闭括号之前无空格
      'startTag': 'never',
      'endTag': 'never',
      'selfClosingTag': 'always'
    }],
    'vue/attributes-order': 2, // 标签里面的属性--顺序
    'vue/singleline-html-element-content-newline': 0, // 内容元素为一行，换行
    'vue/prop-name-casing': [2, 'camelCase'], // props 接收的属性名称为驼峰形式
    'vue/attribute-hyphenation': [2, 'never'], // template中调用组件时，组件属性名称是否使用小驼峰
    "vue/order-in-components": 2, // 组件声明属性的顺序 ———— 默认顺序：name、components、props、data、computed、watch、methods
