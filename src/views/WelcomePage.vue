    ...
    <div class="content-main clearfix">
      ...
      <div class="main">
        ...
        <div class="tab-content clearfix">
          ...
          <el-card class="box-card2">
            <div slot="header" class="clearfix"><span style="line-height: 36px;">下单</span></div>
            <div class="text item">
              <span>加入购物车</span>
          ...
          <el-card class="box-card2">
            <div slot="header" class="clearfix"><span style="line-height: 36px;">支付</span></div>
            <div class="text item">
              <span>成交订单数</span>
