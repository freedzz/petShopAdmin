<template>
  <div class="wrap">
    <div class="main">
      <el-tabs v-model="activeName" class="tabs-wrap" @tab-click="handleClick">
      ...
      <div class="form-table-box">
        <el-table :data="tableData" style="width: 100%" stripe>
          ...
          <el-table-column prop="retail_price" label="售价" width="90" sortable>
            <template slot-scope="scope">
              <el-input v-model="scope.row.retail_price" placeholder="售价" @blur="submit(scope.$index, scope.row)"></el-input>
            </template>
          </el-table-column>
          <el-table-column label="上架" width="60">
            <template slot-scope="scope">
              <el-switch v-model="tableData[scope.$index].is_on_sale" activeText="" inactiveText="" @change="changeStatus($event, tableData[scope.$index].goods_id)"></el-switch>
            </template>
          </el-table-column>
        </el-table>
      </div>
